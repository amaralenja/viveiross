...
import { computeLinhas } from "@/lib/relatorios-calc";
...
function RelatoriosPage() {
  ...
  async function exportPdf(ids?: string[], mode: "save" | "blob" = "save"): Promise<{ blob: Blob; filename: string } | void> {
    ...
    for (let idx = 0; idx < alvo.length; idx++) {
      ...
      // 1) CABEÇALHO: grade de métricas do viveiro (restaurado a pedido do cliente)
      const metrics: [string, string][] = [
        ...
        ["Desp. próprias", formatBRL(l.custoOutrosLanc + l.custoDespIndiv + l.custoCaixaIndiv)],
